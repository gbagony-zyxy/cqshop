		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:seller" />${message("admin.role.seller")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerRank" />${message("admin.role.sellerRank")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerServe" />${message("admin.role.sellerServe")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerAudit" />${message("admin.role.sellerAudit")}
						</label>
					</span>
				</td>
			</tr>
