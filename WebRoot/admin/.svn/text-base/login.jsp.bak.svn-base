...
<%@page import="com.cqshop.framework.Setting"%>
<%@page import="com.cqshop.util.SettingUtils"%>
<%@page import="com.cqshop.util.SpringUtils"%>
<%@page import="com.cqshop.framework.Setting.CaptchaType"%>
<%@page import="com.cqshop.framework.Setting.AccountLockType"%>
<%@page import="com.cqshop.service.RSAService"%>
	...
	<%if (applicationContext != null) {%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="5" align="center" valign="bottom">
				...
				<div class="powered">COPYRIGHT © 2015 ALL RIGHTS RESERVED.</div>
				<div class="link">
