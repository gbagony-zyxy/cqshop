...
<%
	...
	boolean iscqshopXmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/cqshop.xml");
	boolean iscqshopPropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/cqshop.properties");
	...
	String iscqshopXmlCanWriteInfo = null;
	if (iscqshopXmlCanWrite) {
		iscqshopXmlCanWriteInfo = "<span class=\"green\">√</span>";
	} else {
		iscqshopXmlCanWriteInfo = "<span class=\"red\">×</span>";
	}
	String iscqshopPropertiesInfo = null;
	if (iscqshopPropertiesWrite) {
		iscqshopPropertiesInfo = "<span class=\"green\">√</span>";
	} else {
		iscqshopPropertiesInfo = "<span class=\"red\">×</span>";
	}
...
$().ready( function() {
	...
	<%if ((freeSpace != 0 && freeSpace < 51200) || (maxMemory != 0 && maxMemory < 128) || !iscqshopXmlCanWrite || !iscqshopPropertiesWrite || !isWebXmlCanWrite || !isUploadCanWrite) { %>
		hasWarn = true;
	<% } %>
...
<body>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/cqshop.xml
					</td>
					<td>
						可写
					</td>
					<td>
						<%=iscqshopXmlCanWriteInfo%>
					</td>
				</tr>
				<tr>
					<td>
						/WEB-INF/classes/cqshop.properties
					</td>
					<td>
						可写
					</td>
					<td>
						<%=iscqshopPropertiesInfo%>
					</td>
				</tr>
				<tr>
					<td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2013 cqshop.net All Rights Reserved.</p>
	</div>
</body>
</html>