...
import com.cqshop.framework.Principal;
...
import com.cqshop.service.RSAService;
import com.cqshop.util.DeviceUtils;
import com.cqshop.util.SettingUtils;
import com.cqshop.util.WebUtils;
...
public class LoginController extends BaseController {
	...
	public String index(String redirectUrl, HttpServletRequest request,
			ModelMap model) {
		boolean flag = DeviceUtils.isMobileDevice(request);
	...
	public @ResponseBody Message submit(String captchaId, String captcha,
		...
		if (!flag
				&& !captchaService.isValid(CaptchaType.memberLogin, captchaId,
						captcha)) {
