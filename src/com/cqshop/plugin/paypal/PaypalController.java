 ...
 * 
 */
package com.cqshop.plugin.paypal;
...
import com.cqshop.plugin.PaymentPlugin.FeeType;
import com.cqshop.plugin.paypal.PaypalPlugin.Currency;
...
public class PaypalController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/net/cqshop/plugin/paypal/setting";
	}
