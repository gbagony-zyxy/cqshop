...
import com.cqshop.framework.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Document document = new SAXReader().read(cqshopXmlFile);
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/cqshop/template[@id='productContent']");
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "t_product_specification")
	@OrderBy("order asc")
	...
	@CollectionTable(name = "t_product_member_price")
