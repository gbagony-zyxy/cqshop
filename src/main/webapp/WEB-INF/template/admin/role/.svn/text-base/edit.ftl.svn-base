...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.role.sellerGroup")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:seller"[#if role.authorities?seq_contains("admin:seller")] checked="checked"[/#if] />${message("admin.role.seller")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerRank"[#if role.authorities?seq_contains("admin:sellerRank")] checked="checked"[/#if] />${message("admin.role.sellerRank")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerServe"[#if role.authorities?seq_contains("admin:sellerServe")] checked="checked"[/#if] />${message("admin.role.sellerServe")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:sellerAudit"[#if role.authorities?seq_contains("admin:sellerAudit")] checked="checked"[/#if] />${message("admin.role.sellerAudit")}
						</label>
					</span>
				</td>
			</tr>
