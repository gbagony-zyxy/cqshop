	...
	<table class="main">
				...
				<div id="nav" class="nav">
					<ul>
						...
						[#list ["admin:member", "admin:memberRank", "admin:memberAttribute", "admin:review", "admin:consultation"] as permission]
							...
							[/@shiro.hasPermission]
						[/#list]
						[#list ["admin:seller", "admin:sellerRank", "admin:sellerServe", "admin:sellerAudit"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
									<a href="#seller">${message("admin.main.sellerNav")}</a>
								</li>
								[#break /]
							[/@shiro.hasPermission]
						[/#list]
		...
		<tr>
			<td id="menu" class="menu">
				...
				<dl id="seller">
					<dt>${message("admin.main.sellerGroup")}</dt>
					[@shiro.hasPermission name="admin:seller"]
						<dd>
							<a href="../seller/list.jhtml" target="iframe">${message("admin.main.seller")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:sellerRank"]
						<dd>
							<a href="../seller_rank/list.jhtml" target="iframe">${message("admin.main.sellerRank")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:sellerServe"]
						<dd>
							<a href="../seller_serve/list.jhtml" target="iframe">${message("admin.main.sellerServe")}</a>
						</dd>
					[/@shiro.hasPermission]
					[@shiro.hasPermission name="admin:sellerAudit"]
						<dd>
							<a href="../seller_audit/list.jhtml" target="iframe">${message("admin.main.sellerAudit")}</a>
						</dd>
					[/@shiro.hasPermission]
				</dl>
				<dl id="content">
