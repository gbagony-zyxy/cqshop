...
import com.cqshop.framework.ExcelView;
...
public class CouponController extends BaseController {
	...
	public String edit(Long id, ModelMap model) {
		((Model) model).addAttribute("coupon", couponService.find(id));
	...
	public String list(Pageable pageable, ModelMap model) {
		((Model) model).addAttribute("page", couponService.findPage(pageable));
	...
	public String build(Long id, Model model) {
