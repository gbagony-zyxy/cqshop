...
import com.cqshop.framework.Setting.AccountLockType;
import com.cqshop.framework.Setting.CaptchaType;
import com.cqshop.framework.Setting.ConsultationAuthority;
import com.cqshop.framework.Setting.ReviewAuthority;
import com.cqshop.framework.Setting.RoundType;
import com.cqshop.framework.Setting.StockAllocationTime;
import com.cqshop.framework.Setting.WatermarkPosition;
import com.cqshop.service.CacheService;
...
public class SettingController extends BaseController {
	...
	Message mailTest(String smtpFromMail, String smtpHost, Integer smtpPort, String smtpUsername, String smtpPassword, String toMail) {
		...
		try {
			...
			Exception[] messageExceptions = (Exception[]) e.getSuppressed();
	...
	public String update(Setting setting, MultipartFile watermarkImageFile, RedirectAttributes redirectAttributes) {
		...
		try {
			org.springframework.core.io.Resource resource = new ClassPathResource(CommonAttributes.CQSHOP_PROPERTIES_PATH);
