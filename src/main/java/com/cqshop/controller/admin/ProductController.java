...
import com.cqshop.entity.Goods;
import com.cqshop.entity.MemberRank;
...
import com.cqshop.entity.ProductImage;
...
import com.cqshop.service.GoodsService;
import com.cqshop.service.MemberRankService;
import com.cqshop.service.MemberService;
import com.cqshop.service.ProductCategoryService;
import com.cqshop.service.ProductImageService;
...
public class ProductController extends BaseController {
	...
	public String save(Product product, Long productCategoryId, Long brandId, Long[] tagIds, Long[] specificationIds, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		//商家
		product.setSeller(sellerService.find(1l));
...
//		product.setSeller(1l);
	...
	public String update(Product product, Long productCategoryId, Long brandId, Long[] tagIds, Long[] specificationIds, Long[] specificationProductIds, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		if (pProduct.getSeller() != null) {
			product.setSeller(pProduct.getSeller());
		}
		for (MemberRank memberRank : memberRankService.findAll()) {
			String price = request.getParameter("memberPrice_" + memberRank.getId());
			if (StringUtils.isNotEmpty(price) && new BigDecimal(price).compareTo(new BigDecimal(0)) >= 0) {
	...
	public String list(Long productCategoryId, Long brandId, Long promotionId, Long tagId, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isGift, Boolean isOutOfStock, Boolean isStockAlert, Pageable pageable, Model model) {
		ProductCategory productCategory = productCategoryService.find(productCategoryId);
		Brand brand = brandService.find(brandId);
		//商家
		Seller seller = sellerService.find(1L);
		...
		model.addAttribute("page", productService.findPage(productCategory, brand, seller,promotion, tags, null, null, null, isMarketable, isList, isTop, isGift, isOutOfStock, isStockAlert, OrderType.dateDesc, pageable));
