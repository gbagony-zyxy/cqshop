...
public class ProductController extends BaseController {
	...
	public String list(@PathVariable Long productCategoryId, Long brandId, Long promotionId, Long[] tagIds,
		...
		model.addAttribute("page", productService.findPage(productCategory, brand, null, promotion, tags,
				attributeValue, startPrice, endPrice, true, true, null, false, null, null, orderType, pageable));
	...
	public String list(Long brandId, Long promotionId, Long[] tagIds, BigDecimal startPrice, BigDecimal endPrice,
			OrderType orderType, Integer pageNumber, Integer pageSize, HttpServletRequest request, Model model) {
		Brand brand = brandService.find(brandId);
		// Seller seller = new Seller();
		Promotion promotion = promotionService.find(promotionId);
		List<Tag> tags = tagService.findList(tagIds);
		...
		model.addAttribute("pageNumber", pageNumber);
		model.addAttribute("pageSize", pageSize);
		model.addAttribute("page", productService.findPage(null, brand, null, promotion, tags, null, startPrice,
