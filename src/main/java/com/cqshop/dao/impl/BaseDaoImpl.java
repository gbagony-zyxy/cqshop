...
import com.cqshop.dao.BaseDao;
import com.cqshop.entity.OrderEntity;
...
import com.cqshop.framework.Filter.Operator;
import com.cqshop.framework.Order.Direction;
	...
	private synchronized String getAlias(Selection<?> selection) {
		if (selection != null) {
			...
			if (alias == null) {
				...
				alias = "cqshopGeneratedAlias" + aliasCount++;
